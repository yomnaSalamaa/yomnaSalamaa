...
- 🧮 **Excel Data Science Salary Calculator Dashboard** - Interactive Excel dashboard that visualizes and analyzes data science salaries with KPIs.
- 🎬 **SQL Movie Data Analysis (SQL)** - An end-to-end SQL project analyzing movie data using PostgreSQL with Executive Summary and recommendations.
